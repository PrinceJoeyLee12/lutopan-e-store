...
import { addToCart } from 'src/modules/CartStore';
import { addToFavourites, FavouritesStore } from 'src/modules/FavouritesStore';
import styles from './ProductCard.module.css';
import { isMobileDevice } from 'src/hook/useWindowDimensions';
...
const ProductCard = (props: any) => {
  ...
  const productCartRef = useRef<any>();
  const productFavouriteRef = useRef<any>();
  ...
  return (
    <IonCol size={isMobile ? '12' : '6'} key={`category_product_list_${index}`}>
      <IonCard
